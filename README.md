About flask-swagger-ui-feedstock
================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/flask-swagger-ui-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/flask-swagger-ui-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add flask-swagger-ui
# for installing globally
pixi global install flask-swagger-ui
```
...
It is possible to list all of the versions of `flask-swagger-ui` available on your platform:
...
```
pixi search flask-swagger-ui --channel conda-forge
```
